...
$sql = "SELECT * FROM artikel WHERE kategori = 'lifestyle' ORDER BY tanggal_publikasi DESC LIMIT 5";
$result = $conn->query($sql);

// Fetch trending Lifestyle posts
$trending_sql = "SELECT * FROM artikel WHERE kategori = 'lifestyle' ORDER BY views DESC LIMIT 4";
...
<head>
    ...
    <style>
        ...
        .article-image {
            width: 259.55px; /* Set fixed width */
            height: 216.8px; /* Set fixed height */
            overflow: hidden;
            border-radius: 8px;
        }
            ...
            <div class="row">
                <div class="col-lg-9 most-recent">
                    ...
                    <div class="list-view">
                        ...
                        <div class="article-container">
                            <div class="article-content">
                                ...
                                <a href="single.php?id=<?php echo $row['id']; ?>" class="blog-desc mt-0">
                                    <?php echo htmlspecialchars(string: $row['judul']); ?>
                                </a>
                        ...
                        <?php 
                            ...
                            echo '<p>No Lifestyle posts found</p>';
                        }
                        ?>
                    </div>
                ...
                <div class="col-lg-3 trending mt-lg-0 mt-5 mb-lg-5">
                    <div class="pos-sticky">
                        <h3 class="section-title-left">Trending Lifestyle</h3>
                        <?php 
                        ...
                        <?php
                            ...
                            echo '<p>No trending Lifestyle posts found</p>';
                        }
                        ?>
                    </div>
                </div>
