...
$sql = "SELECT * FROM artikel WHERE kategori = 'Technology' ORDER BY tanggal_publikasi DESC LIMIT 5";
$result = $conn->query($sql);

// Fetch trending Technology posts
$trending_sql = "SELECT * FROM artikel WHERE kategori = 'Technology' ORDER BY views DESC LIMIT 4";
                ...
                <div class="col-lg-9 most-recent">
                    ...
                    <div class="list-view">
                        ...
                        <?php 
                            ...
                            echo '<p>No technology posts found</p>';
                        }
                        ?>
                    </div>
                ...
                <div class="col-lg-3 trending mt-lg-0 mt-5 mb-lg-5">
                    <div class="pos-sticky">
                        ...
                        <?php
                            ...
                            echo '<p>No trending technology posts found</p>';
                        }
                        ?>
                    </div>
                </div>
